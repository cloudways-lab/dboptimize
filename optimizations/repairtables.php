...
class WP_DbOptimization_repairtables extends WP_DbOptimization {
	...
	public function get_info() {
		...
		if (0 == $corrupted_tables) {
			$this->register_output(__('No corrupted tables found', 'wp-dboptimize'));
		} else {
	...
	public function settings_label() {
		return __('Repair database tables', 'wp-dboptimize');
	}
}
