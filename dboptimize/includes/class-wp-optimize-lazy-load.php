...
class WP_DbOptimize_Lazy_Load {
	...
	/**
	 * WP_DbOptimize_Lazy_Load constructor.
	 */
	public function __construct() {
		...
		$this->options = wp_parse_args(WP_DbOptimize()->get_options()->get_option('lazyload'), $default_options);
		...
		$hook_these = apply_filters('wp_dboptimize_lazy_load_hook_these', array('get_avatar', 'the_content', 'widget_text', 'get_image_tag', 'post_thumbnail_html', 'woocommerce_product_get_image', 'woocommerce_single_product_image_thumbnail_html'));
		
		$hook_priority = apply_filters('wp_dboptimize_lazy_load_hook_priority', PHP_INT_MAX);
