 ...
 */
abstract class WP_DbOptimization {
	...
	protected function query($sql) {
		...
		do_action('wp_dboptimize_optimization_query', $sql, $this);
		$result = $this->wpdb->query($sql);
		return apply_filters('wp_dboptimize_optimization_query_result', $result, $sql, $this);
	}
	...
	public function get_sites() {
		return WP_DbOptimize()->get_sites();
	}
	...
	public function get_results() {
		...
		return apply_filters('wp_dboptimize_optimization_results', $results, $this->id, $this);
	}
	...
	public function get_preview_link($text, $attributes = array()) {
		...
		if (false == $this->support_preview || false == WP_DbOptimize::is_premium()) return $text;
