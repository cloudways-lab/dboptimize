...
/**
 * Class WP_DbOptimization_Images_Shutdown
 *
...
class WP_DbOptimization_Images_Shutdown {
	...
	/**
	 * WP_DbOptimization_Images_Shutdown constructor.
	 */
	...
	/**
	 * Get WP_DbOptimization_Images_Shutdown instance.
	 *
	 * @return WP_DbOptimization_Images_Shutdown
	 */
	static public function get_instance() {
		if (!self::$_instance) {
			self::$_instance = new WP_DbOptimization_Images_Shutdown();
		}
	...
	public function shutdown() {
		...
		if ($queue_id) {
			WP_DbOptimize_Tasks_Queue::this($queue_id)->unlock();
		}
