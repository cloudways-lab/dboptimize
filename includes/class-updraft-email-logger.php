...
class Updraft_Email_Logger extends Updraft_Abstract_Logger {
	...
	public function log($level, $message, array $context = array()) {
		...
		$log = WP_DbOptimize()->get_options()->get_option('updraft_mail_logger_log', array());

		$message = '['.Updraft_Log_Levels::to_text($level).'] : '.$this->interpolate($message, $context);

		$log[] = $message;
		WP_DbOptimize()->get_options()->update_option('updraft_mail_logger_log', $log);
	}
	...
	public function flush_log() {
		...
		WP_DbOptimize()->get_options()->update_option('updraft_mail_logger_log', array());
	...
	public function get_log() {
		return WP_DbOptimize()->get_options()->get_option('updraft_mail_logger_log', array());
	}
}
