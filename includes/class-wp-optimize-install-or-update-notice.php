 ...
 */
class WP_DbOptimize_Install_Or_Update_Notice {
	...
	public function output_notice() {
		WP_DbOptimize()->include_template('notices/install-or-update-notice.php', false, array(
			'is_new_install' => $this->is_new_install(),
			'is_premium' => WP_DbOptimize::is_premium(),
	...
	private function is_updraftplus_installed() {
		$status = WP_DbOptimize()->get_db_info()->get_plugin_status('updraftplus');
