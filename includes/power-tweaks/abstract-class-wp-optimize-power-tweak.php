...
abstract class WP_DbOptimize_Power_Tweak {
	...
	public function output() {
		WP_DbOptimize()->include_template('database/power-tweak.php', false, $this->get_data());
	}
	...
	public function get_data() {
		return array_merge(
			array(
				...
				'last_run' => WP_DbOptimize()->get_options()->get_option('tweak_last_run_'.$this->tweak_name, false),
				'updated_status' => WP_DbOptimize()->get_options()->get_option('tweak_updated_status_'.$this->tweak_name, false),
