...
class WP_DbOptimize_Power_Tweaks {
	...
	public function __construct() {
		...
		include_once WPODB_PLUGIN_MAIN_PATH.'/includes/power-tweaks/abstract-class-wp-optimize-power-tweak.php';
	...
	public function initialize_tweaks() {
		...
		$path = WPODB_PLUGIN_MAIN_PATH.'includes/power-tweaks/';
		$handle = opendir($path);
