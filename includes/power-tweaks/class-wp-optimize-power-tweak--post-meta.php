...
class WP_DbOptimize_Power_Tweak__Post_Meta extends WP_DbOptimize_Power_Tweak {
	...
	public function test_availability() {
		$last_run = WP_DbOptimize()->get_options()->get_option('tweak_last_run_post-meta', false);
		if (false === $last_run) {
...
return new WP_DbOptimize_Power_Tweak__Post_Meta();
