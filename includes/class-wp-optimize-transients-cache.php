...
class WP_DbOptimize_Transients_Cache {
	...
	/**
	 * @return WP_DbOptimize_Transients_Cache
	 */
	...
	public function set($key, &$value, $expiration = 0) {
		...
		if (WP_DbOptimize()->get_free_memory() > $keep_free_mem) {
	...
	public function set_transient($key, $value, $expiration = 0) {
		if (WP_DbOptimize()->is_multisite_mode()) {
