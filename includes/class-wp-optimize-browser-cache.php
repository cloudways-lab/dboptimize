...
/**
 * Class WP_DbOptimize_Browser_Cache
 */
class WP_DbOptimize_Browser_Cache {
	...
	/**
	 * WP_DbOptimize_Browser_Cache constructor.
	 */
	public function __construct() {
		$this->_wp_optimize = WP_DbOptimize();

		$this->_htaccess = new WP_DbOptimize_Htaccess();
	...
	/**
	 * Handle for enable_browser_cache command used in WP_DbOptimize_Commands.
	 *
